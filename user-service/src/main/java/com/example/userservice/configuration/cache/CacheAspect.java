...
import com.example.userservice.annotation.cache.CacheAction;
import com.example.userservice.annotation.cache.CacheCollection;
import com.example.userservice.annotation.cache.CacheMap;
import com.example.userservice.annotation.cache.CacheUpdate;
import com.example.userservice.util.ReflectionUtil;
...
public class CacheAspect {
    ...
    private boolean compare(Object origin, Object returnValue, String[] compareProperties) {
        for (String property : compareProperties) {
            Object originPv = com.example.userservice.util.ReflectionUtil.getFieldValue(origin, property);
