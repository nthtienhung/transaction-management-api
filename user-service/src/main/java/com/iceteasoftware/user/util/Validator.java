...
import com.iceteasoftware.user.constant.RegularExpressionConstants;
...
public class Validator {
    ...
    public static boolean isPasswordRegex(String password) {
        if (password.length() < com.iceteasoftware.user.constant.Constants.DEFAULT_PASSWORD_LENGTH_MIN
                || password.length() > com.iceteasoftware.user.constant.Constants.DEFAULT_PASSWORD_LENGTH_MAX){
            return false;
        }
