package com.example.configservice.configuration.message;

import com.example.configservice.constant.Constants;
import com.example.configservice.util.GetterUtil;
