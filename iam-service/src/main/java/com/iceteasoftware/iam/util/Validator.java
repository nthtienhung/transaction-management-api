 ...
 */
package com.iceteasoftware.iam.util;

import com.iceteasoftware.iam.constant.RegularExpressionConstants;
...
public class Validator {
    ...
    private static final char DEFAULT_PERCENT_SIGN = '%';
    private static final String DEFAULT_BACKSLASH = "\\";
    ...
    public static boolean isPassword(String password) {
        ...
        for (int i = 1; i < password.length() - 1; i++) {
            if (password.charAt(i) == CharPool.SPACE) {
                return false;
            }
        }
    ...
    public static boolean isPasswordRegex(String password) {
        if (password.length() < com.iceteasoftware.iam.constant.Constants.DEFAULT_PASSWORD_LENGTH_MIN
                || password.length() > com.iceteasoftware.iam.constant.Constants.DEFAULT_PASSWORD_LENGTH_MAX){
            return false;
        }
