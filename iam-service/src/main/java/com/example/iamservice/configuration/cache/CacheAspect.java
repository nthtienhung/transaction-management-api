...
import com.example.iamservice.annotation.cache.CacheAction;
import com.example.iamservice.annotation.cache.CacheCollection;
import com.example.iamservice.annotation.cache.CacheMap;
import com.example.iamservice.annotation.cache.CacheUpdate;
import com.example.iamservice.util.ReflectionUtil;
...
public class CacheAspect {
    ...
    private boolean compare(Object origin, Object returnValue, String[] compareProperties) {
        for (String property : compareProperties) {
            Object originPv = com.example.iamservice.util.ReflectionUtil.getFieldValue(origin, property);
